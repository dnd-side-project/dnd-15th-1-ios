...
public struct PlaceClient: Sendable {
    ...
    /// 저장 취소. placeID 는 `Place.placeID` 인 장소 번호다
    public var removePlace: @Sendable (_ placeID: String) async throws -> Void
    /// 공용 장소 상세. placeID 는 `Place.placeID` 인 장소 번호다
    public var placeDetail: @Sendable (_ placeID: String) async throws -> PlaceDetail
    ...
    public var updateAlias: @Sendable (_ placeID: String, _ alias: String?) async throws -> SavedPlace
}
