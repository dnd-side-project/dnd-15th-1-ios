...
final class ProfileRepositoryTests: XCTestCase {
    ...
    func test_온보딩_미완료면_POST로_초기화하고_성향에_null을_보낸다() async throws {
        ...
        XCTAssertTrue(json?.keys.contains("datePreferences") == true)
        XCTAssertTrue(json?["datePreferences"] is NSNull)
    }
